...
```{r taxonomy_boxplot_phylum, fig.height=8, fig.width=10, fig.fullwidth=TRUE}
...
```{r taxonomy_boxplot_family, fig.height=8, fig.width=10, fig.fullwidth=TRUE}
...
```{r taxonomy_boxplot_genus, fig.height=8, fig.width=10, fig.fullwidth=TRUE}
...
```{r beta_div_nmds_neutral_plot, comment="", message=FALSE, warning=FALSE, fig.height=8, fig.width=10, fig.fullwidth=TRUE}
beta_q0n$S %>%
