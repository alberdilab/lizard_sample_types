...
```{r ancom_model_mag, comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{r ancom_stats_mag, comment="", message=FALSE, warning=FALSE}
...
```{r ancombc_plot_mag, comment="", message=FALSE, warning=FALSE}
...
```{r ancom_model_genus, comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{r ancom_stats_genus, comment="", message=FALSE, warning=FALSE}
tax <- data.frame(phyloseq@tax_table) %>%
  rownames_to_column(., "taxon")
...
```{r ancom_model_phylum, comment="", message=FALSE, warning=FALSE, eval=FALSE}
...
```{r ancom_stats_phylum, comment="", message=FALSE, warning=FALSE}
...
```{r ancombc_plot_phylum, comment="", message=FALSE, warning=FALSE, eval=FALSE}
differential_abundance_phylum_table %>%
